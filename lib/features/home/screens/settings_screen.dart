...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  void _openInfoDialog({required String title, required String message}) {
    showDialog<void>(
      context: context,
      builder: (context) {
        return AlertDialog(
    ...
    return FutureBuilder<String?>(
      ...
      builder: (context, snapshot) {
        ...
        return _buildSettingsTile(
          ...
          title: isLoggedIn ? 'My Account' : 'Create Account',
          onTap: isLoggedIn ? _openMyAccount : () => context.go('/register'),
        );
      },
    );
  }
